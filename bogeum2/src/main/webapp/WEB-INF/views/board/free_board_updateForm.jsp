...
<div class="board_wrap">
    ...
    <form id="form_total">
        <input type="hidden" id="id" value="${free.id}">
        <div class="board_write">
            <div class="title form_group">
                <dl>
                    <dt>제목</dt>
                    <dd><input type="text" class="form_control" placeholder="제목 입력" id="title" value="${free.title}"></dd>
                </dl>
            </div>
            <br>
            <div class="cont form_group">
                <textarea rows="5" class="form_control summernote" id="content">${free.content}</textarea>
            </div>
        </div>
    </form>
    <div class="bt_wrap">
