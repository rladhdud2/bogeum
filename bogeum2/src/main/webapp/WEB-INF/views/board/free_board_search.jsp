    ...
    <div class="board_wrap2">
        ...
        <div class="board_list_wrap">
            <div class="board_list">
                ...
                <c:forEach var="freelist" items="${freeList.content}">
                    <div>
                        <div class="num">${freelist.id}</div>
                        <div class="title"><a href="/free/${freelist.id}">${freelist.title}</a></div>
                        <div class="writer">${freelist.users.username}</div>
                        <div class="date"><fmt:formatDate
                                pattern="yyyy-MM-dd HH:mm" value="${freelist.createDate}"/></div>
                        <div class="count">${freelist.count}</div>
                    </div>
                </c:forEach>
            </div>
